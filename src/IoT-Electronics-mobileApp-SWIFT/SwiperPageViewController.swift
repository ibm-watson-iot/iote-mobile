...
class SwiperPageViewController: UIPageViewController {
    
    weak var tutorialDelegate: SwiperPageViewControllerDelegate?
...
extension SwiperPageViewController: UIPageViewControllerDataSource {
...
extension SwiperPageViewController: UIPageViewControllerDelegate {
...
protocol SwiperPageViewControllerDelegate: class {
